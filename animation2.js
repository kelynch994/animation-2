...
(lib.chromesearch___localntp_localntphtmliPhone6_7_81 = function() {
	this.initialize(img.chromesearch___localntp_localntphtmliPhone6_7_81);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,862,1754);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(6).to({startPosition:0},0).to({regX:0.1,regY:0.1,scaleY:0.7143,x:400.05,y:470.3},3,cjs.Ease.quadIn).to({regX:0,regY:0.2,scaleX:0.8571,scaleY:1.1428,x:400,y:410.05},7).to({regY:0,scaleX:0.7143,scaleY:0.7143,y:470.3},11,cjs.Ease.quadOut).wait(5));
...
// library properties:
lib.properties = {
	id: '1C7B87F261464912B497FD9BC1AA32FA',
	width: 800,
	height: 600,
	fps: 24,
	color: "#000033",
	opacity: 1.00,
	manifest: [
		{src:"images/chromesearch___localntp_localntphtmliPhone6_7_81.png", id:"chromesearch___localntp_localntphtmliPhone6_7_81"}
	],
	preloads: []
};
...
an.compositions['1C7B87F261464912B497FD9BC1AA32FA'] = {
